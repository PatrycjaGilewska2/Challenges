...
public class StringConstants {
    ...
    public static final String EXAMPLE_JSON_PATH = "src/test/resources/exampleData.json";
    public static final String FULL_JSON_PATH = "src/test/resources/fullData.json";
